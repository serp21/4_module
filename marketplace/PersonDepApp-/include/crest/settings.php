<?php
define('C_REST_CLIENT_ID','local.66d83574532fd0.22127283');//Application ID
define('C_REST_CLIENT_SECRET','LmgI1RQFgP66rIQvqspV1QXPyq1IPOKKh9PRscyfQ9mdVmB3kf');//Application key
// or
