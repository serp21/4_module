...
class HTML {
    ...
    private static function getPage(array $param) {
        ...
        $table = self::getTable($param['TABLE']);
        $footer = self::getFooter($param['TOTAL'], $USER->onPageGet(), $param['SELECTED']);
    ...
    private static function getMain(array $param) {
        ...
        $table = self::getTable($param['TABLE']);
        $footer = self::getFooter($param['TOTAL'], $param['ON_PAGE'], $param['SELECTED']);
    ...
    private static function getTable(array $data) {
        global $USER;
        ...
        if (self::$type == 'user') {
            ...
            foreach ($data as $info) {
                ...
                if (!isset($columns['department']) || $columns['department'] === true) {
                    ...
                    if (isset($info['UF_DEPARTMENT']) && !empty($info['UF_DEPARTMENT'])) {
