                    ...
                    <div class="modal-body">
                        <table id="accTable" class="table-bordered table-sm" style="width: 100%;">
                            <tbody>
                                ...
                                <!--<tr><td>Ответственный за платёж</td><td colspan="4"><select id="f_card" name="f_card"><option></option></select></td></tr> -->
                ...
                <div class="modal-body" id="PFbody">
                    ...
                    <form action="" id="ModalPartForm" onsubmit="return false">
                                <table style="width: 100%;">
                                    ...
                                    <tr style="display:none"><td colspan="2"><br><label><input id="PFci" name="PFci" type="checkbox" value="1"> Создать счёт на оплату <small>(только при списании на задачу)</small></label></td></tr>
                                </table>
...
?>
    ...
    <script src="pub/js/functions7.11.4.js"></script>
    <script>
        $('#ModalPartForm').on('click', function(){
            if($('[name=selTypeList]:checked').val() == 1){
                console.log(1);
            }else{
                $('#PFci').prop('checked', false).css('display:none');
            }
        });
    </script>
</body>
