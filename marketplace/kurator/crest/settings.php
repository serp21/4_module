<?php
define('C_REST_CLIENT_ID','local.675831bb291f98.47968974');//Application ID
define('C_REST_CLIENT_SECRET','d2OfwvOvdYUtpo9Ku0bzXLp7HmfMV9B353iAVdH5E2DeQAIYRr');//Application key
// or
