<?php
define('C_REST_CLIENT_ID','local.67556636d81836.21844026');//Application ID
define('C_REST_CLIENT_SECRET','ZQ5UI28mVzG37jgick2VSPV7oBnVJgZPoIV4r2pKu4Le02fSas');//Application key
// or
